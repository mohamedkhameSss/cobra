  ...
  return (
      ...
      <section className='bg-slate-100 grainy-dark py-24'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            ...
            <img src='public/snake-2.png' className='w-24 order-0 lg:order-2' />
          </div>
      ...
      <section>
        ...
        text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
          Upload your photo and get <span className="relative px-2 
          bg-green-600 text-white"> your own case</span> now
        </h2>
        </div>
        </div>
        ...
        <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
          ...
          <div className="relative h-80 md:h-full w-full
           ...
           rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10
            lg:rounded-2xl">
           <img src="public/horse.jpg" className="rounded-md object-cover
            bg-white shadow-2xl ring-1
           ring-gray-900/10 h-full w-full" alt="" />
           </div>
