          ...
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            ...
            >
              <div className='absolute w-28 -left-0 -top-20 hidden lg:block'>
                <img src='/snake-0.jpg' className='w-full' />
              </div>
              ...
              >
                ...
                protesct your memories, not just your phone case
              </p>
              <ul className='mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start'>
                <div className='space-y-2'>
                  ...
                  <li className='flex gap-1.5 items-center text-left'>
                    <CheckIcon className='text-green-600' />5 years print
                    garantee
                  </li>
                  <li className='flex gap-1.5 items-center text-left'>
                    <CheckIcon className='text-green-600' />
              ...
              >
                <div className='flex -space-x-4'>
                  <img
                    src='/public/users/user-1.png'
                    alt='user image'
                    className='inline-block h-10 w-10 
                      rounded-full ring-2 ring-slate-100'
                  />
                  <img
                    src='/public/users/user-2.png'
                    alt='user image'
                    className='inline-block h-10 w-10 
                      rounded-full ring-2 ring-slate-100'
                  />
                  <img
                    src='/public/users/user-3.png'
                    alt='user image'
                    className='inline-block h-10 w-10 
                      rounded-full ring-2 ring-slate-100'
                  />
                  <img
                    src='/public/users/user-4.jpg'
                    alt='user image'
                    className='inline-block h-10 w-10 
                      rounded-full ring-2 ring-slate-100'
                  />
                  <img
                    src='/public/users/user-5.jpg'
                    alt='user image'
                    className='object-cover inline-block h-10 w-10 
                      rounded-full ring-2 ring-slate-100'
                  />
                </div>
              </div>
      ...
      <section>
        ...
        text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
           ...
           md:justify-self-end max-w-sm 
           rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10
            lg:rounded-2xl'
              >
                <img
