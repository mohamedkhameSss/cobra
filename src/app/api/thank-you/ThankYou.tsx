...
const ThankYou = () => {
  ...
  const { configuration, BillingAdress, shippingAddress, amount }: any = data;
      ...
      <div className='mx-auto max-w-3xl px-4 sm:px-6 sm:py-24 lg:px-8'>
        <div className='max-w-xl'>
          ...
          <div className='mt-12 text-sm font-medium'>
            <p className='text-zinc-900'>Order numder</p>
        ...
        <div
          className='flex space-x-6 overflow-hidden mt-4 rounded-xl bg-gray-900/5  ring-1 ring-inset
        ...
        <div>
          <div className='grid grid-cols-2 gap-x-6 py-10 text-sm'>
            <div>
              <p className='font-medium text-gray-900'>Shhipping address</p>
            ...
            <div>
              ...
              <div className='mt-2 text-zinc-700'>
                <address className='not-italic'>
                  ...
                  <span className='block'>
                    {BillingAdress?.postalCode} {BillingAdress?.city}
                  </span>
                </address>
              </div>
            </div>
